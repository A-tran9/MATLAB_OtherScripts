...
% file_name = uigetfile('*.xls', 'Pick any file');
...
%All Trials
trial_data_adj_temp = reshape(trial_data_adj,[251,28000]);
A = fft(trial_data_adj_temp,256);
B = A.*conj(A)/256;
trial_data_fft = reshape(B,[256,14,2000]);
